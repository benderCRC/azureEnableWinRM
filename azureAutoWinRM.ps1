...
ansible-playbook -i 10.25.0.4, Windows_ULL.yml -v -e private_ip=10.25.0.4 -e target=all -e ansible_connection=winrm -e ansible_user=crcadmin -e ansible_password=p -e ansible_winrm_transport=ssl
}
