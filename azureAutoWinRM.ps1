...
ansible-playbook -i " + $IP + ", Windows_ULL.yml -v -e private_ip=" + $IP +" -e target=all -e ansible_connection=winrm -e ansible_user= -e ansible_password=p -e ansible_winrm_transport=ssl"
)
